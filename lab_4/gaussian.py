...
def gaussian():
  ...
  t.add_row(["Выборочное математическое ожидание распределения Гаусса", round(mv, 3)])
  t.add_row(["Выборочная дисперсия c известным МО распределения Гаусса", round(find_dispersion(x_gauss, m_gauss), 3)])
  t.add_row(["Выборочная дисперсия c неизвестным МО распределения Гаусса", round(find_dispersion(x_gauss, mv), 3)])
